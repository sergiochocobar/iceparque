...
export const events: Event[] = [
	{ title: 'Reunión de Mujeres — Todo tiene su tiempo', start: '2026-09-12T15:30:00-03:00', end: '2026-09-12T18:00:00-03:00', category: 'Especial', mode: 'presencial', location: 'ICE Parque - Aristóbulo del Valle 2580, Parque San Martín, Merlo', description: 'Tema: “Todo tiene su tiempo” (Eclesiastés 3) — Es tiempo de florecer. Compartiremos una merienda. Taller de manualidades con Margarita Farías.' },
